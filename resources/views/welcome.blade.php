            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="button-get-started">
                        <a href="{{ route('login') }}" class="btn btn-danger btn-fill btn-lg ">
                            Entrar
                        </a>
                    </div>
                </div>
...
<br>
            <div class="button-get-started" style="text-align:center;">
                <a href="{{ route('register') }}" class="btn btn-danger btn-lg">Registrar</a>
            </div>
        </div>
    </div>
            ...
            <div class="container">
                ...
                var nivelAcertos = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Acertos',
                            data: [ {{ $pesquisa }}, {{ $graduacao }}, {{ $mestrado }}, {{ $doutorado }}, {{ $especializacao }}],
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
                ...
                <br><br><br>
                <div class="button-get-started">
                    <a href="{{ route('verTemas') }}" class="btn btn-fill btn-lg">Ver Temas!</a>
                </div>
            </div>
    </div>
    <div class="section section-small section-get-started">
        <div class="parallax filter filter-color-black">
            <div class="image" style="background-image:url('{{ asset('img/chart.jpg') }}')">
            </div>
            <div class="container">
                <div class="title-area">
                    ...
                    <div class="separator line-separator">♦</div>
                        ...
                        @foreach($ultimos as $ultimo)
                          <li class="list-group-item d-flex justify-content-between align-items-center row">
                            <div class="col-md-8"><a href="{{ route('verTemasOrderBy', ['order' => 'created_at', 'for' => 'desc']) }}#tema_{{ $ultimo->id }}">{{ $ultimo->titulo }}</a></div>
                            <div class="col-md-4"><a href="{{ route('verTemasNivel', ['nivel' => $ultimo->nivel ]) }}"><span class="badge badge-info badge-pill">{{ $ultimo->nivel }}</span></div>
                          </li>
                        @endforeach
                        </ul>
                    </div>
    ...
    <div class="section section-small section-get-started">
      <div class="parallax filter filter-color-black">
          <div class="image" style="background-image:url('{{ asset('img/help_us.jpeg') }}')">
          </div>
            <div class="container">
                <div class="title-area">
                    <h2>Sugestões?</h2>
                ...
                <div class="button-get-started">
                    <a href="{{ route('contato') }}" class="btn btn-danger btn-fill btn-lg">Entre em contato!</a>
                </div>
            </div>
        </div>
    </div>

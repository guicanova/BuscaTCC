                ...
                <div class="col-md-12">
                  <form class="form-horizontal" method="POST" action="<?php echo e(route('enviarMensagem')); ?>" enctype="multipart/form-data">
                      ...
                      <div class="form-group<?php echo e($errors->has('mensagem') ? ' has-error' : ''); ?>">
                          ...
                          <div class="col-md-6">
                              <textarea rows="20" id="mensagem" type="text" placeholder="Digite sua mensagem!" class="form-control" name="mensagem" value="<?php echo e(old('mensagem')); ?>" required></textarea>

...
<body>
    ...
    <nav class="navbar navbar-default <?php if(Route::currentRouteName()==''): ?> navbar-transparent <?php endif; ?> navbar-fixed-top navbar-burger" color-on-scroll="200">
                    ...
                    <div class="info">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <a href="#">Buscar Temas</a>
                                </li>
                                <li>
                                    <a href="#">Inserir Temas</a>
                                </li>
                                <li>
                    ...
                    <div class="info">
                        <h5 class="title"> Ajuda e Suporte</h5>
                         <nav>
                            <ul>
                                <li>
                                    <a href="<?php echo e(route('contato')); ?>">Fale Conosco!</a>
                                </li>
                                <li>

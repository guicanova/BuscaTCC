<?php $__env->startSection('content'); ?>
        ...
        <div class="parallax filter filter-color-blue">
          ...
          <div class="container">
              <div class="content">
                  ...
                  <button class="btn btn-danger btn-fill btn-lg" href="<?php echo e(route('logout')); ?>"
              ...
              <div class="card card-member">
                  <div class="content">
                    ...
                    <div class="button-get-started">
                        <a href="<?php echo e(route('verTemas')); ?>" class="btn btn-default btn-lg ">
                            Buscar
                        </a>
                    </div>
                  </div>
            ...
            <div class="col-md-6">
              <div class="card card-member">
                  <div class="content">
                    ...
                    <div class="button-get-started">
                        <a href="<?php echo e(route('inserirTema')); ?>" class="btn btn-default btn-lg ">
                            Inserir
                        </a>
                    </div>
                  </div>
    ...
    <div class="section section-small section-get-started">
        <div class="parallax filter filter-color-green">
            <div class="image"
                style="background-image: url('<?php echo e(asset('/img/fale_conosco.jpeg')); ?>')">
            </div>
            <div class="container">
                <div class="title-area">
                    <h2>Sugestões?</h2>
                ...
                <div class="button-get-started">
                    <a href="<?php echo e(route('contato')); ?>" class="btn btn-white btn-lg">Entre em contato!</a>
                </div>
            </div>
        </div>
    </div>
